...
var AttendancePage = /** @class */ (function () {
    function AttendancePage(loadingController, camera, router, modalCtrl, httpClient, actionSheetController, formBuilder, modalController, toastController) {
    ...
    AttendancePage.prototype.capture = function (isEntry) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var options, imageData, body;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        imageData = _a.sent();
                        body = { photo: imageData, isEntry: isEntry };
                        this.httpClient.post('http://15.207.71.113:3000/login/search_face', body).subscribe(function (data) {
                            // if (data != null) {
                            _this.attendanceList = data;
                            if (_this.attendanceList.code == 200) {
                                _this.httpClient.post('http://15.207.71.113:3000/users/attendance', body).subscribe(function (data) {
                                    // if (data != null) {
                                    _this.attendanceList1 = data;
                                    // alert(JSON.stringify(this.attendanceList1))
                                    if (_this.attendanceList1.code == 200) {
                                        _this.goToConfirmcomponent();
                                    }
                                    else if ((_this.attendanceList1.code == 404)) {
                                        _this.goToNonConfirmcomponent('Error Network Connection', 'error');
                                    }
                                    // }else {
                                    // }
                                });
                            }
                            else if (_this.attendanceList.code == 404) {
                                _this.goToNonConfirmcomponent('Face Not Match', 'cancel');
                            }
                            else {
                                _this.goToNonConfirmcomponent('No Face Found', 'error');
                            }
                        });
    ...
    AttendancePage.prototype.goToConfirmcomponent = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AttendancePage.prototype.goToNonConfirmcomponent = function (data, type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    AttendancePage.prototype.presentToast = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
