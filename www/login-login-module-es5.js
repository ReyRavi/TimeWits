...
var LoginPage = /** @class */ (function () {
    function LoginPage(router, fb, httpClient, toastController) {
        this.router = router;
        this.fb = fb;
    ...
    LoginPage.prototype.onLogin = function () {
        var _this = this;
        var body = { employeeNumber: this.login.value.employeeNumber, password: this.login.value.password };
        this.httpClient.post('http://15.207.71.113:3000/login/', body).subscribe(function (data) {
            if (data != null) {
                _this.loginList = data;
                // this.login.reset();
                if (_this.loginList.code == 200) {
                    _this.presentToast();
                    console.log("Login Successful");
                    _this.router.navigate(['/home']);
                }
                else if (_this.loginList.code == 404) {
                    _this.presentToast1();
    ...
    LoginPage.prototype.presentToast1 = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
